...
const Skill = ({ name, x, y }) => {
    return <motion.div
        className='flex items-center justify-center rounded-full font-semibold bg-dark text-light py-3 px-6
            ...
            xs:bg-transparent xs:dark:bg-transparent xs:font-bold xs:text-dark xs:dark:text-light'
        ...
        <>
            ...
            md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
                <motion.div
                    ...
                    dark:text-dark dark:bg-light bg-dark text-light p-8 shadow-dark cursor-pointer
                ...
                <Skill name={"Material Ui"} x={"0vw"} y={"-20vw"} />
            </div>
        </>
    )
}
